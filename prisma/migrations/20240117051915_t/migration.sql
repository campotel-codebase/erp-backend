/*
  ...
  - Added the required column `CustomRoutingApproval` to the `LeaveRequest` table without a default value. This is not possible if the table is not empty.
...
ALTER TABLE [dbo].[LeaveRequest] ADD [CustomRoutingApproval] VARCHAR(255) NOT NULL,
